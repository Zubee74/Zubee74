👋 Hi, I'm Mohammad Zubair, you can me on google @zubee74

💻 Software Test Engineer | QA | Automation & Manual Tester  
📍 Navi Mumbai | Open to Remote / Hybrid / On-site  

🚀 About Me
- 3 years of experience in Software Testing
- Expertise in Manual, API & Automation Testing
- Strong in Selenium, Cypress, Playwrite, TestNG, Rest Assured
- Passionate about improving product quality and automation

🛠️ Tech Stack
- Languages: Java, JavaScript, SQL
- AI: ChatGPT, Cursor AI, Cloud AI, Gemini
- Automation: Selenium, Playwrite, TestNG, Cypress  
- API Testing: Postman, Swagger, Rest Assured  
- Tools: Jira, Maven, Jenkins, GitHub
- Communication tools: Slack, MS team, Google meet  
- Others: Allure Reports, RTM, Test Planning, MS Excel, Canva
